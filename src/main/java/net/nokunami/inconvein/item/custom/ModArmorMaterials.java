...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    STEEL("steel", 24, new int[]{2, 6, 7, 3},
            10, SoundEvents.ARMOR_EQUIP_IRON, 1.5F, 0.0F, () -> {
        return Ingredient.of(ModItems.STEEL_INGOT.get());
    }),
    DIARKRITE("diarkrite", 34, new int[]{3, 6, 8, 3},
            15, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.2F, () -> {
        return Ingredient.of(ModItems.DIARKRITE_INGOT.get());
    });
    ...
    public String getName() {
        return Inconvein.MOD_ID + ":" + this.name;
    }
